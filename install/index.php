...
'license'=>'<div class="license"><h1>系统安装协议</h1>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 微赢CMS智能微信互动营销系统，还是部份栏目使用 微信公共平台，在你使用了 微赢CMS智能微信互动营销系统的网站主页上必须加上 微赢CMS智能微信互动营销系统  官方网址(<a href="http://cms.weiwin.cc" target="_blank">cms.weiwin.cc</a>)的链接。</p>
				<p>4、未经官方许可，禁止在 微赢CMS智能微信互动营销系统  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p><b>版本最新更新：</b> 2014年4月18日</p>
                <p align=right>BY 微赢CMS智能微信互动营销系统</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 微赢CMS智能微信互动营销系统V'.SOFT_VERSION.' 安装程序',
...
$dirfile_items = array(
    'conf' => array('type' => 'file', 'path' => './weiwindata/conf/db.php'),
);
...
(1, '".$username."', '".$password."', 5, 1, '', 1383453875, '127.0.0.1', '')");
			...
			@fclose($fp);
			$fp1 = @fopen(ROOT_PATH.'sc/data/install.lock','wb+');
			@fclose($fp1);
		}else{
...
<meta content="微赢CMS智能微信互动营销系统" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by 微赢CMS智能微信互动营销系统© v3.0 2012-2013</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
...
function config_edit() {
	...
	$config1 = '../sc/data/config/db.php';
	$configfile1 = include($config1);
	$configfile1['DB_TYPE']='mysql';
	$configfile1['DB_HOST']=$dbhost;
	$configfile1['DB_NAME']=$dbname;
	$configfile1['DB_USER']=$dbuser;
	$configfile1['DB_PWD' ]=$dbpw;
	$configfile1['DB_PORT']=$dbport;
	$configfile1['DB_PREFIX']="weixin_";
				
	if (phpversion() > 5.0){
		@file_put_contents($config, "<?php\nreturn ".var_export($configfile,true).";\n?>");
		@file_put_contents($config1, "<?php\nreturn ".var_export($configfile1,true).";\n?>");
	}
	$status=1;$msg='';
