    ...
    if (isIE && ieVer < 9) {
        ...
        addEvent(global, 'load', function () {
            var alertConStr = '<div  style="position: absolute;top: 50%;left: 50%;width: 398px;height: 440px;margin: -239px 0 0 -230px;padding: 10px 40px;text-align: center;background-color: #fff;border-radius: 2px;">\
                                    <img id="ie8img" style="cursor: pointer; position: absolute; right: 10px; top: 10px; width: 30px; height: 30px;" src="http://esf.js.soufunimg.com/esf/zu/image/x_330.jpg" alt="">\
                                    ...
                                    <div class="con">\
                                        ...
                                        <dl style="width: 294px;height: 132px;margin: 0 auto;margin-top: 25px">\
                                            ...
                                            <dt style="float: right;text-align: center;">\
                                                <div style="width: 89px;height: 86px;border: 1px solid #CCCCCC;border-radius: 2px;text-align: center;padding: 8px;"><img style="width:89px;height:89px" src="//static.soufunimg.com/common_m/pc_public/images/ewm_bgesf.png" alt="房天下app"></div>\
            ...
            var ie8img = document.getElementById("ie8img");
            if (ie8img) {
                ie8img.onclick = function () {
                    document.getElementById("ie8win").style.display = "none";
                }
            }
        });
    }
