/* Chosen v0.13.0 | (c) 2011-2013 by Harvest | MIT License, https://github.com/harvesthq/chosen/blob/master/LICENSE.md */ ! function() {
	...
	function() {
		...
		a = this, AbstractChosen = function() {
			...
			}, AbstractChosen.default_multiple_text = "请选择", AbstractChosen.default_single_text = "请选择", AbstractChosen.default_no_result_text = "没有匹配的结果", AbstractChosen
		...
		b = this, a = jQuery, a.fn.extend({
			...
			return e(Chosen, d), Chosen.prototype.setup = function() {
				...
				return this.container.mousedown(function(b) {
					...
					if(a.options.my_keyup){
						var thiskeycode = b.keyCode;
						if(thiskeycode==8 || thiskeycode==32 || (thiskeycode>=48&&thiskeycode<=57) || (thiskeycode>=65&&thiskeycode<=90) || (thiskeycode>=96&&thiskeycode<=105)){
							var myfun = a.options.my_keyup;
							myfun();
						}
					}else{
						a.keyup_checker(b);
