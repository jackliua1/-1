...
class DiningAction extends UserAction{
	...
	public function orderInfo(){
		...
		if (IS_POST){
			...
			$dining_cart_model->where(array('id'=>$thisOrder['id']))->save(array('paid'=>intval($_POST['paid']),'sent'=>intval($_POST['sent']),'logistics'=>$_POST['logistics'],'logisticsid'=>$_POST['logisticsid'],'handled'=>1));
