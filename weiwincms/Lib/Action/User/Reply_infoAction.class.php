...
class Reply_infoAction extends UserAction{
	...
	public function _initialize() {
		...
		'Repast'=>array('type'=>'Repast','name'=>'微点餐','keyword'=>'微点餐','url'=>'/index.php?g=Wap&m=Repast&a=index&dining=1&token='.$this->token),
		'Store'=>array('type'=>'Store','name'=>'高级商城','keyword'=>'高级商城','url'=>'/index.php?g=Wap&m=Product&a=Store&token='.$this->token),
	...
	public function set(){
		...
		if(IS_POST){
			...
			$row['copyrighturl']=$this->_post('copyrighturl');     //版权链接
			$row['indextitle']=$this->_post('indextitle');  //商城首页标题
