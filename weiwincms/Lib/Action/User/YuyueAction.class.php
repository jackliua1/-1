		...
		if(IS_POST){ 
			...
			if($this->Yuyue_model->create()){
				...
				if($_POST["lbs"]==1){
					...
					$_POST['phone']=$arr[0]['phone'];

					$_POST['address']=$arr[0]['address'];

					$_POST['longitude']=$arr[0]['longitude'];

					$_POST['latitude']=$arr[0]['latitude'];

				}else{
					$_POST['phone'] = $_POST['my_phone'];
				}
				unset($_POST['my_phone']);
				//print_r($_POST);die;
