...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="site_name" value="<?php echo ($f_siteName); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：微赢官网</span>
	  </td>
    </tr>
	 <tr> 
	 ...
	 <tr> 
      ...
      <td><input type="text" name="site_url" value="<?php echo ($f_siteUrl); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://www.weiwinbao.com</span>
    </tr>  
	<tr> 
    ...
    <tr> 
      ...
      <td  height="48" align="right"><strong>图灵聊天key：</strong></td>

      <td><input type="text" name="site_chatkey" value="<?php echo C('site_chatkey');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;聊天机器人key，请到www.tuling123.com申请</span>
	...
	<tr> 
      ...
      <td><input type="text" name="ipc" value="<?php echo C('ipc');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：浙IPC备12587号</span>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <td><input type="text" name="site_email" value="<?php echo C('site_email');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:QQ:server@weiwin.cc</span>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <td><textarea	 type="text" name="copyright" class="ipt" style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo C('copyright');?></textarea><span>&nbsp;&nbsp;例:weiwin版权所有</span>
    </tr>
