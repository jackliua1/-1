...
<div class="cLineB">
  <h4>新增销售状态</h4><a href="<?php echo U('Wechat_behavior/salesstatus');?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div> 
  ...
  <form action="" method="post" class="form-horizontal form-validate" novalidate="novalidate">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="salesstatus" id="title" maxlength="10" class="span4" value="<?php echo ($list["salesstatus"]); ?>" data-rule-required="true"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		<label for="Tel" class="control-label">状态描述：</label>
		<div class="controls">
			<input type="text" name="statusinstr" id="statusinstr" class="span4" data-rule-required="true" value="<?php echo ($list["statusinstr"]); ?>" style="width:500px;"><span class="maroon">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="sort" id="sort" class="span4" data-rule-required="true" value="<?php echo ($list["sort"]); ?>" style="width:500px;"><span class="maroon">
