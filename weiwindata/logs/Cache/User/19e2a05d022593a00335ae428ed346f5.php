...
<div class="content">
  ...
  <div class="cLineD"></div>
      ...
      <div class="cLine">
        <div class="ftip" style="margin:0 auto">项目的销售状态设置</div>
      </div>
  ...
  <div class="cLine">
    <div class="pageNavigator left">
       <a href="<?php echo U('Wechat_behavior/salesstatusadd',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
            <img src="tpl/User/default/common/images/text.png" class="vm">新增状态
        </a>
        <!-- &nbsp;
        ...
        &nbsp;
        <a href="<?php echo U('Wechat_behavior/statisticsoutexc',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
  ...
  <div class="msgWrap">
    <form method="post" action="" id="info">
      ...
      <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
        <thead>
          <tr>
            <th class="span3">状态名称</th>
            <th class="span3">状态说明</th>
            <th class="span3">进程顺序</th>
            <th class="span3">操作</th>
          </tr>
        </thead>
        <tbody>
          <?php if($list == ''): ?><tr>
            <td colspan="6" style="text-align:center; height:30px;"><strong>暂无销售状态</strong></td>
            </tr>
          <?php else: ?>
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
            <td><?php echo ($list['salesstatus']); ?></td>
            <td><span class="label"> <?php echo ($list['statusinstr']); ?></span></td>
            <td><?php echo ($list['sort']); ?></td>
            <td>
              <a href="<?php echo U('Wechat_behavior/salestatusOfModule',array('id'=>$list['id'],'token'=>$list['token']));?>" class="btn">编辑</a>
              &nbsp;<a href="<?php echo U('Wechat_behavior/salestatusOfDel',array('id'=>$list['id'],'token'=>$list['token']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn">删除</a></a>
            </td>
