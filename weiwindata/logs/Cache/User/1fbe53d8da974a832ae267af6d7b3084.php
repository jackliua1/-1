...
<div class="content">
          <div class="cLineB"><h4>驻场经理维护</h4></div>
		<div class="searchbar right">  
			<form method="post" action="<?php echo U('Wechat_zhiye/index',array('token'=>$token));?>">
			  <input type="text" class="txt left" placeholder="输入手机号" name="Tel" value="<?php echo ($Tel); ?>">
			  <select name="lpid" data-placeholder="选择所属楼盘" id="lpid" style="" class="chosen-select">
				<option value=""></option>
      ...
      <div class="msgWrap form">
        <ul id="tags" style="width:100%">
          <li class="selectTag">
            <a href="?g=User&m=Wechat_zhiye&a=index">驻场经理</a> 
          </li>
          <!-- <li>
            <a href="?g=User&m=Wechat_zhiye&a=custom">意向客户分配</a> 
          </li> -->
        <!-- <li>
        ...
        <div class="clr" style="height:1px;background:#eee;margin-bottom:20px;"></div>
          ...
          <div class="cLine">
            <div class="pageNavigator left">
                <a href="<?php echo U('Wechat_zhiye/addzhiye',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
                    <img src="tpl/User/default/common/images/text.png" class="vm">新增
                </a> 
                <!-- &nbsp;&nbsp;
                <a class="btnGrayS vm bigbtn" id="import">
                    <img src="tpl/User/default/common/images/text.png" class="vm">导入置业
                </a> -->
             ...
             <script type="text/javascript">
                ...
                hide();
                window.location="<?php echo U('Wechat_zhiye/index');?>";
                });
                  //点击取消
              ...
              $("#dvMsk").remove();
               ...
               <div id="showDiv" style="display:none;">
                 ...
                 <div class="imtem" style="width:300px;">
                  <a href="tpl/User/default/common/tmp/驻场经理.xls"><button class="btuFile"  id="" style="margin-top:5px;margin-left:10px;padding:5px;">下载模板</button></a>
                  </div>
                  <form action="<?php echo U('Wechat_zhiye/excinzhiye',array('token'=>$token));?>" method="post" enctype="multipart/form-data">
                   ...
                   <table border="0" style="margin-top:10px;" >
                    ...
                    <tr height="50px;">
                      ...
                      <td style="text-align:center;">
                         <a href="<?php echo U('Wechat_zhiye/index');?>" id="close" ><input type="button" style="width:100px;height:30px;" value="取消" /></a>
                      </td>
                    </tr>
                    </table>
                  </center>
           ...
           <input name="wxid" type="hidden" value="gh_423dwjkewad">
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
             ...
             <tr>                      
      				...
      				<th class="span3">手机</th>
      				<!-- <th class="span1">所属项目</th> -->
              <th class="span3">创建日期</th>
              <!-- <th class="span3">绑定日期</th> -->
              <th class="span3">操作</th>
      			</tr>
			  </thead>
				<tbody>
					<?php if($list == ''): ?><tr>
						<td colspan="6" style="text-align:center; height:30px;"><strong>暂无驻场经理信息.</strong></td>
						</tr>
					<?php else: ?>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
            <td><?php echo ($list['Name']); ?></td>
            <td><?php echo ($list['Tel']); ?></td>
            <!-- <td><?php echo ($list['LouPanTitle']); ?></td> -->
            <td><?php echo (date("Y-m-d",$list['addTime'])); ?></td>
						<!-- <td><?php if($list['BDTime'] != 0): echo (date("Y-m-d",$list['BDTime'])); else: ?>暂未绑定<?php endif; ?></td> -->
						<td>
							<a href="<?php echo U('Wechat_zhiye/edit',array('id'=>$list['ID'],'token'=>$list['Token']));?>" class="btn">修改</a>
							&nbsp;<a href="<?php echo U('Wechat_zhiye/del',array('id'=>$list['ID'],'token'=>$list['Token']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn">删除</a></a>
						</td>
