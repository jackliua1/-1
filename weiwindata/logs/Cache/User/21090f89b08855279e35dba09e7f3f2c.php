    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr>
        <th><span class="red">*</span>几室：</th>
        <td><input type="text" name="storeids" value="<?php echo ($set["storeids"]); ?>" class="px" style="width:100px;" /></td>
       </tr>
       <tr>
        <th><span class="red">*</span>公交：</th>
        <td><input type="text" name="gongjiao" value="<?php echo ($set["gongjiao"]); ?>" class="px" style="width:100px;" /></td>
       </tr>
       <tr>
        <th><span class="red">*</span>周边配套：</th>
        <td><input type="text" name="peitao" value="<?php echo ($set["peitao"]); ?>" class="px" style="width:400px;" /></td>
       </tr>
       <tr>
        <th><span class="red">*</span>价格：</th>
        <td><input type="text" id="price" onchange="calDiscount();" name="price" value="<?php echo ($set["price"]); ?>" class="px" style="width:100px;" />万</td>
       </tr>
       <tr> 
        <th><span class="red">*</span>面积：</th>
        <td><input type="text" id="oprice" onchange="calDiscount();" name="measure" value="<?php echo ($set["measure"]); ?>" class="px" style="width:100px;" /> ㎡</td>
       </tr>
       <tr>
        <th><span class="red">*</span>朝向：</th>
        <td><input type="text" id="opricese" onchange="calDiscount();" name="chaoxiang" value="<?php echo ($set["chaoxiang"]); ?>" class="px" style="width:100px;" /></td>
       </tr>
       <tr>
        <th><span class="red">*</span>层数：</th>
        <td><input type="text" id="oprices" onchange="calDiscount();" name="layers" value="<?php echo ($set["layers"]); ?>" class="px" style="width:100px;" /></td>
       </tr>
       <tr> 
        <th><span class="red">*</span>平方价：</th>
        <td><input type="text" id="mailprice" onchange="calDiscount();" name="mailprice" value="<?php echo ($set["mailprice"]); ?>" class="px" style="width:100px;" /> 元</td> 
       </tr>
        <tr> 
        <th><span class="red">*</span>区：</th>
        <td><input type="text" name="keyword" value="<?php echo ($set["keyword"]); ?>" class="px" style="width:100px;" /></td>
       </tr>
       <tr>
        <th><span class="red">*</span>街道：</th>
        <td><input type="text" name="Street" value="<?php echo ($set["Street"]); ?>" class="px" style="width:100px;" /></td>
       </tr>
        <tr> 
        <th><span class="red">*</span>图片：</th>
        <td><input type="text" name="logourl" value="<?php echo ($set["logourl"]); ?>" class="px" id="pic" style="width:400px;" /> &nbsp; <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,700,'<?php echo ($token); ?>')" class="a_upload">上传</a> &nbsp; <a href="###" onclick="viewImg('pic')" class="btnGrayS vm">预览</a></td> 
       </tr>
