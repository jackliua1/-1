...
<div class="content">
  ...
  <div class="cLine">
    <div class="ftip" style="margin:0 auto">维护注册条款信息，只有管理员可进行操作</div>
  </div>       
  ...
  <div class="msgWrap form">
    <ul id="tags" style="width:100%">
      <li class="selectTag">
        <a href="<?php echo U('Recognition/index');?>">会员条款</a> 
      </li>
      <li>
        <a href="<?php echo U('Recognition/zytk');?>">驻场经理条款</a> 
      </li>
      <li>
        <a href="<?php echo U('Recognition/actk');?>">项目总监条款</a> 
      </li>
  ...
  <div class="cLine">
    <div class="pageNavigator left">
       <!-- <a href="<?php echo U('Wechat_behavior/statisticsOfModule',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
            <img src="tpl/User/default/common/images/text.png" class="vm">修改客户
        </a>
        &nbsp; -->
  ...
  <div class="msgWrap bgfc" style=" padding:5px 10px; margin:0">
    <form class="form" method="post" action="" target="_top" enctype="multipart/form-data">
      <table class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellspacing="0" cellpadding="0" width="100%">
        <thead>
          <tr>
            <th valign="top"><label for="title">注册条款：</label></th>
            <td>
              <!-- <input type="input" class="px" required="" id="title" value="" name="title" style="width:400px"> 请认真填写生成后不可以编辑！只能删除重建<br>: -->
              <textarea name="TiaoKuan" style="width:400px;height:300px;border:1px solid #00ffff;resize:none"><?php echo ($content["TiaoKuan"]); ?></textarea>
            </td>
          </tr>
          <tr>
            <td>
