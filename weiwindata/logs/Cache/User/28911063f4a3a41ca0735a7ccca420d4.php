          ...
          <!-- <div class="ftip" style="margin:25px auto 5px auto;height:73px;">多媒体上传限制：图片最大128K，支持JPG格式；语音最大256K，播放长度不超过60s，支持AMR\MP3格式；视频（video）最大1MB，支持MP4格式；媒体文件在后台保存时间为3天，3天后将失效。 </div> -->
           <div class="cLine">
            <div class="pageNavigator left">
               <!--  <a href="<?php echo U('Message/customOfModule',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
                    <img src="./tpl/User/default/common/images/pic.png" class="vm">修改意向客户信息
                </a> -->
            </div>
            <div class="clr"></div>
          </div>
           ...
           <input name="wxid" type="hidden" value="gh_423dwjkewad">
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
             ...
             <th class="span3">姓名</th>
              ...
              <th class="span3">会员</th>
              <th class="span3">驻场经理</th>
              <th class="span3">客户意向</th>
              ...
              <th class="span3">操作</th>
				...
				<tbody>
					<?php if($list == ''): ?><tr>
						<td colspan="9" style="text-align:center; height:30px;"><strong>暂无意向客户信息.</strong></td>
						</tr>
					<?php else: ?>
            ...
            <td>
              <?php if($list["zy_name"] == ''): ?><span class="label">未分配驻场经理</span><?php endif; ?>
              <span class="label"> <?php echo ($list['zy_name']); ?></span>
            </td>
            ...
            <td>
              ...
              <?php else: ?>
                <span class="label"> <?php echo (date('Y-m-d',$list['yxTime'])); ?></span><?php endif; ?>
						...
						<td>
							<a href="<?php echo U('Message/customOfModule',array('id'=>$list['ID'],'token'=>$list['Token']));?>" class="btn">编辑</a>
							&nbsp;<a href="<?php echo U('Message/customdel',array('id'=>$list['ID'],'token'=>$list['Token']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn">删除</a></a>
						</td>
