...
<div class="content">
 ...
 <div class="cLineD">
          ...
          <div class="cLine">
		    <div class="ftip" style="margin:0 auto">首页分享内容</div>
		</div>
        ...
        <li>
          <a href="<?php echo U('Wechat_behavior/salesstatus',array('token'=>$_GET['token']));?>">项目销售状态</a> 
        </li>
        <li>
          <a href="<?php echo U('Wechat_behavior/rewardparam',array('token'=>$_GET['token']));?>">奖励类型设置</a> 
        </li>
        <li>
          <a href="<?php echo U('Wechat_behavior/rewardinfo',array('token'=>$_GET['token']));?>">项目奖励</a> 
        </li>
        <li>
          <a href="<?php echo U('Wechat_behavior/agenttype',array('token'=>$_GET['token']));?>">会员类别</a> 
        </li>
        <li>
          <a href="<?php echo U('Wechat_behavior/invitationcode',array('token'=>$_GET['token']));?>">邀请码</a> 
        </li>
        <li class="selectTag">
    ...
    <form method="post"   action=""  enctype="multipart/form-data" >
          <div class="msgWrap form">
            <TABLE class="userinfoArea" border="0" cellSpacing="0" cellPadding="0" width="100%">
                <TR>
                  <TH valign="top"><label for="pic">分享标题：</label></TH>
                  <TD><input class="px"  name="sharetitle" id="name" value="<?php echo ($info['sharetitle']); ?>" style="width:200px;"  /></TD>
                </TR>
                <TR>
                  <TH valign="top"><label for="pic">项目图片：</label></TH>
                  <TD>
                    <input class="px"  name="shareimg" value="<?php if($info['shareimg'] == ''): ?>/tpl/User/default/common/images/lp/fd039245d688d.jpg<?php else: echo ($info['shareimg']); endif; ?>" id="pic1" style="width:363px;"  />
                    <br />
                      <a href="###" onclick="upyunPicUpload('pic1',700,420,'<?php echo ($token); ?>')" id="upload" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a>&nbsp;
                  </TD>
                </TR>
                 <TR>
                  <TH valign="top"><label for="pic">分享内容：</label></TH>
                  <TD><textarea class="px" name="sharecontent" id="sharecontent" style="width:400px;resize:none;" ><?php echo ($info['sharecontent']); ?></textarea></TD>
                </TR>
                <TR>
                  <TD>
