...
<script src="/tpl/static/artDialog/plugins/iframeTools.js"></script>
 ...
 <script src="<?php echo RES;?>/js/Wechat_zhiye_addzhiye.js"></script>
<div class="content">
<style>
...
<div class="cLineB">
  <h4>新增经纪公司</h4><a href="<?php echo U('Brokerage/index',array('token'=>$token));?>" class="right btnGrayS vm">返回</a>
 </div> 
  <div class="msgWrap bgfc">
  <form action="#" method="post" class="form-horizontal form-validate" novalidate="novalidate">
	<input type="hidden" name="id" value="<?php echo ($id); ?>">
	<div class="control-group">
		<label for="title" class="control-label">经纪公司名称：</label>
		<div class="controls">
			<input type="text" name="usersname" id="title" maxlength="30" class="span4" value="<?php echo ($brokerage["usersname"]); ?>" data-rule-required="true"><span class="maroon"></span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		  <label for="contacts" class="control-label">经纪公司联系人：</label>
		  <div class="controls">
			  <input type="text" name="contacts" id="contacts" class="span4" data-rule-required="true" value="<?php echo ($brokerage["contacts"]); ?>"><span class="maroon"></span><span class="help-inline"></span>
		  </div>
	  </div>
	<div class="control-group">
		<label for="Tel" class="control-label">经纪公司电话：</label>
		<div class="controls">
			<input type="text" name="tel" id="Tel" class="span4" data-rule-required="true" value="<?php echo ($brokerage["tel"]); ?>"><span class="maroon"></span><span class="help-inline"></span>
		</div>
	</div>
	  <div class="control-group">
		  <label for="address" class="control-label">经纪公司地址：</label>
		  <div class="controls">
			  <input type="text" name="address" id="address" class="span4" data-rule-required="true" value="<?php echo ($brokerage["address"]); ?>"><span class="maroon"></span><span class="help-inline"></span>
		  </div>
	  </div>
	  <div class="control-group">
		  <label for="in_area" class="control-label">所在区域：</label>
		  <div class="controls">
			  <input type="text" name="in_area" id="in_area" class="span4" data-rule-required="true" value="<?php echo ($brokerage["in_area"]); ?>"><span class="maroon"></span><span class="help-inline"></span>
		  </div>
	  </div>
	  <div class="control-group">
		  <label for="list" class="control-label">片区经理：</label>
		  <div class="controls">
			  <select name="areaName" style="height:30px;">
				<option value="">--请选择--</option>
				  <?php if(is_array($list)): foreach($list as $key=>$vo): ?><option  value="<?php echo ($vo["ID"]); ?>" <?php if($vo[ID] == $brokerage[areas_ID]): ?>selected<?php endif; ?>><?php echo ($vo["areaName"]); ?></option><?php endforeach; endif; ?>
			  </select>
		  </div>
	  </div>
   ...
   <div class="form-actions">
			<button id="bsubmit" type="submit" data-loading-text="提交中..." class="btnGreen">保存</button>　<a href="<?php echo U('Brokerage/index',array('token'=>$token));?>" class="btnGray vm">取消</a>
		</div>
</form>
  </div> 
