...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/cymain.css" />
        <div class="content" style="width:96%; background:none; margin-left:2%; border:none; margin-bottom:30px;" >
<div class="cLineB">
<h4 class="left">广告设置(<?php echo ($page); ?>) </h4>
<div class="clr"></div>
</div>

<div class="cLine">
<div class="pageNavigator left"> 
	<a href="<?php echo U('Advert/AdvertAdd',array('token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加广告</a>
</div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<td><?php echo ($item["advertname"]); ?></td>
<td><?php echo ($item["pname"]); ?></td>
<td><?php echo ($item["sort"]); ?></td>
<!-- <td><?php echo ($item["schoolname"]); ?></td>  -->

<td class="norightborder">
	<a href="<?php echo U('Advert/AdvertSet',array('id'=>$item['id'],'token'=>$token));?>">修改</a>&nbsp;&nbsp;<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Advert/AdvertDelete',array('id'=>$item['id'],'token'=>$token));?>');">删除</a></td>
