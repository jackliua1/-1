  ...
  <div class="cLineD"></div>
	...
	<div class="msgWrap form">
		<ul id="tags" style="width:100%">
			<li class="selectTag">
				<a href="<?php echo U('Wechat_behavior/statistics');?>">意向客户维护</a> 
			</li>
			<li>
				<a href="<?php echo U('Wechat_behavior/statisticsTrend');?>">经纪人维护</a> 
			</li>
			<li>
				<a href="<?php echo U('Wechat_behavior/statisticsAnchang');?>">案场经理</a> 
			</li>
			<li>
				<a href="<?php echo U('Wechat_behavior/statisticsZhiye');?>">置业顾问</a> 
			</li>
      <li>
        <a href="<?php echo U('Wechat_behavior/rule');?>">活动细则</a> 
      </li>
      ...
      <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tbody>
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
              <a href="<?php echo U('Wechat_behavior/statisticsOfModule',array('id'=>$list['ID'],'token'=>$list['Token']));?>" class="btn">编辑</a>
              &nbsp;<a href="<?php echo U('Wechat_behavior/statisticsOfDel',array('id'=>$list['ID'],'token'=>$list['Token']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn">删除</a></a>
            </td>
