...
<div class="cLineB">
  <h4>新增项目奖励</h4><a href="<?php echo U('Wechat_behavior/rewardinfo');?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div> 
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="loupanid" style="height:30px;">
				<?php if(is_array($lp)): $i = 0; $__LIST__ = $lp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["LouPanTitle"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="statusid" style="height:30px;">
				<?php if(is_array($sta)): $i = 0; $__LIST__ = $sta;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["salesstatus"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
			<span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<select name="rewardid" style="height:30px;">
				<?php if(is_array($rew)): $i = 0; $__LIST__ = $rew;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["rewardname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
			<span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
