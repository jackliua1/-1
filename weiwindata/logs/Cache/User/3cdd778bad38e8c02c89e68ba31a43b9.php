...
<div class="cLineB">
  <h4>新增片区经理</h4><a href="<?php echo U('Districtmanager/index',array('token'=>$token));?>" class="right btnGrayS vm" >返回</a>
 </div> 
  <div class="msgWrap bgfc">
  <form action="<?php echo U('Districtmanager/add',array('token'=>$token));?>" method="post" class="form-horizontal form-validate" novalidate="novalidate">
	<div class="control-group">
		<label for="title" class="control-label">片区经理姓名：</label>
		<div class="controls">
			<input type="text" name="areaName" id="title" maxlength="10" class="span4" value="<?php echo ($lists["areaName"]); ?>" data-rule-required="true"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		<label for="Tel" class="control-label">片区经理手机号：</label>
		<div class="controls">
			<input type="text" name="areaTel" id="Tel" class="span4" data-rule-required="true" value="<?php echo ($lists["areaTel"]); ?>"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		<label for="Tel" class="control-label">登录密码：</label>
		<div class="controls">
			<input type="password" name="password" id="password" class="span4" data-rule-required="true" value=""><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	 

	  <!--<div class="control-group">-->
		  <!--<label for="usersname" class="control-label">管辖经纪公司：</label>-->
		  <!--<div class="controls">-->
			  <!--<select name="usersname" style="height:30px;">-->
				  <!--<?php if(is_array($list)): foreach($list as $key=>$vo): ?>-->
				  <!--<option   value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["usersname"]); ?></option>-->
