		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="picurl" value="<?php echo ($set["picurl"]); ?>" id="pic" class="px" style="width:550px;"> &nbsp; <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> &nbsp; <a href="###" onclick="viewImg('pic')" class="btnGrayS vm">预览</a> &nbsp; 大小为720x400</td>

				</tr>
				<tr>

					<th width="120"><span class="red">*</span>首页标题：</th>

					<td><input type="text" name="indextitle" value="<?php echo ($set["indextitle"]); ?>" class="px" style="width:550px;"></td>
                ...
                <tr>
					...
					<td><input type="text" name="picurls1" value="<?php echo ($set["picurls1"]); ?>" id="pic1" class="px" style="width:550px;"> &nbsp; <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic1',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> &nbsp; <a href="###" onclick="viewImg('pic1')" class="btnGrayS vm">预览</a> &nbsp; 大小为720x400</td>
                 ...
                 <tr>
					...
					<td><input type="text" name="picurls2" value="<?php echo ($set["picurls2"]); ?>" id="pic2" class="px" style="width:550px;"> &nbsp; <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic2',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> &nbsp; <a href="###" onclick="viewImg('pic2')" class="btnGrayS vm">预览</a> &nbsp; 大小为720x400</td>
                  ...
                  <tr>
					...
					<td><input type="text" name="picurls3" value="<?php echo ($set["picurls3"]); ?>" id="pic3" class="px" style="width:550px;"> &nbsp; <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic3',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> &nbsp; <a href="###" onclick="viewImg('pic3')" class="btnGrayS vm">预览</a> &nbsp; 大小为720x400</td>
                ...
                <tr>
					...
					<td><input name="copyright" value="<?php echo ($set["copyright"]); ?>" class="px" style="width:550px;" type="text"><br> 如：微赢版权所有</td>
               ...
               <tr>
					...
					<td><input name="copyrighturl" value="<?php echo ($set["copyrighturl"]); ?>" class="px" style="width:550px;" type="text"><br>外网地址需要以http://开头</td>
