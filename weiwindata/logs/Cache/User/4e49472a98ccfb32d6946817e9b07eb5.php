...
<!-- ----------------------------------------------------------------------------------------------------------------------------------------------------- -->
        ...
        <div class="content">
          ...
          <div class="cLine">
			...
			<a href='__ROOT__/index.php?g=User&m=Lottery&a=add' title='新增幸运大转盘活动' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/img/activity-lottery.png" class="vm" />新增幸运大转盘活动</a>
