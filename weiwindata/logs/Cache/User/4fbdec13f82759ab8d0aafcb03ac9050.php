...
<div class="cLineB">
  <h4>客户信息维护</h4><a href="<?php echo U('ServiceUser/index');?>" class="right btnGrayS vm">返回</a>
 </div> 
  ...
  <form action="" method="post" class="form-horizontal form-validate" novalidate="novalidate">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="Name" id="title" class="span4" value="<?php echo ($list["Name"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label for="Tel" class="control-label">客户电话：</label>
		<div class="controls">
			<input type="text" name="Tel" id="Tel" class="span4" data-rule-required="true" value="<?php echo ($list["Tel"]); ?>">
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<select name="Uid" class="chosen-select lp">
		        <?php if(is_array($lp)): $i = 0; $__LIST__ = $lp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lp): $mod = ($i % 2 );++$i;?><option value="<?php echo ($lp["ID"]); ?>" <?php if($lp['ID'] == $list['Uid']): ?>selected<?php endif; ?>><?php echo ($lp["LouPanTitle"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		      </select>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<select name="zy_id" class="chosen-select zy">
				...
				<?php if(is_array($zy)): $i = 0; $__LIST__ = $zy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["ID"]); ?>" <?php if($vo['ID'] == $list['zy_id']): ?>selected<?php endif; ?>><?php echo ($vo["Name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		      </select>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="jdname" id="jdname"  class="span4" value="<?php echo ($list["jdname"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label for="jdtel" class="control-label">接待人电话：</label>
		<div class="controls">
			<input type="text" name="jdtel" id="jdtel" class="span4" data-rule-required="true" value="<?php echo ($list["jdtel"]); ?>">
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<select class="chosen-select jjgs" data-placeholder="选择经纪公司">
				...
				<?php if(is_array($jjgs)): $i = 0; $__LIST__ = $jjgs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $list['jjgs_id']): ?>selected<?php endif; ?>><?php echo ($vo["usersname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		      </select>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<select name="JJ_id" class="chosen-select jjr" data-placeholder="选择经纪人">
				<option value="0" ></option>
				<?php if($jjr): if(is_array($jjr)): $i = 0; $__LIST__ = $jjr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["ID"]); ?>" <?php if($vo['ID'] == $list['JJ_id']): ?>selected<?php endif; ?>><?php echo ($vo["Name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; endif; ?>
		      </select>
		</div>
	</div>
	<!-- <div class="control-group">
		...
		<div class="controls">
			<input type="text" name="jjrtel" id="jjrtel" class="span4" data-rule-required="true" value="<?php echo ($list["jjrtel"]); ?>">
		</div>
	</div> -->
	<div class="control-group">
		...
		<div class="controls">
			<select name="Stutas">
				<?php if(is_array($status)): $i = 0; $__LIST__ = $status;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $list['Stutas']): ?>selected<?php endif; ?>><?php echo ($vo["salesstatus"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="date" name="SrTime" id="SrTime" class="span4" data-rule-required="true" value="<?php echo (date('Y-m-d',$list["SrTime"])); ?>">
		</div>
	</div>
	<div class="control-group">
		<label for="yxTime" class="control-label">有效日期：</label>
		<div class="controls">
			<input type="date" name="yxTime" id="yxTime" class="span4" data-rule-required="true" value="<?php echo (date('Y-m-d',$list["yxTime"])); ?>">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="products" id="products"  class="span4" value="<?php echo ($list["products"]); ?>" data-rule-required="true"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		<label for="title" class="control-label">楼栋号：</label>
		<div class="controls">
			<input type="text" name="ldh" id="ldh"  class="span4" value="<?php echo ($list["ldh"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label for="title" class="control-label">房号：</label>
		<div class="controls">
			<input type="text" name="houseno" id="houseno"  class="span4" value="<?php echo ($list["houseno"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label for="title" class="control-label">合同面积(平方)：</label>
		<div class="controls">
			<input type="text" name="htmj" id="htmj"  class="span4" value="<?php echo ($list["htmj"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label for="title" class="control-label">合同总价：</label>
		<div class="controls">
			<input type="text" name="htzj" id="htzj"  class="span4" value="<?php echo ($list["htzj"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label for="title" class="control-label">预约日期：</label>
		<div class="controls">
			<input type="date" name="yydate" id="yydate"  class="span4" value="<?php echo ($list["yydate"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label for="title" class="control-label">认购日期：</label>
		<div class="controls">
			<input type="date" name="rgdate" id="rgdate"  class="span4" value="<?php echo ($list["rgdate"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">签约日期：</label>
		<div class="controls">
			<input type="date" name="qydate" id="qydate"  class="span4" value="<?php echo ($list["qydate"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">应收金额：</label>
		<div class="controls">
			<input type="text" name="ysje" class="ysje span4" value="<?php echo ($list["ysje"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">实收金额：</label>
		<div class="controls">
			<input type="text" name="ssje" class="span4 ssje" value="<?php echo ($list["ssje"]); ?>" readonly>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">收款金额1：</label>
		<div class="controls">
			<input type="text" name="skje1" class="span4 skje1" value="<?php echo ($list["skje1"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">收款日期1：</label>
		<div class="controls">
			<input type="date" name="skrq1" id="skrq1"  class="span4" value="<?php echo ($list["skrq1"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">收款方式1：</label>
		<div class="controls">
			<input type="text" name="skfs1" id="skfs1"  class="span4" value="<?php echo ($list["skfs1"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">客户卡号1：</label>
		<div class="controls">
			<input type="text" name="khcard1" id="khcard1"  class="span4" value="<?php echo ($list["khcard1"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">POS单凭证号1：</label>
		<div class="controls">
			<input type="text" name="pos_pzh1" id="pos_pzh1"  class="span4" value="<?php echo ($list["pos_pzh1"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">收据编号1：</label>
		<div class="controls">
			<input type="text" name="sjnum1" id="sjnum1"  class="span4" value="<?php echo ($list["sjnum1"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">收款金额2：</label>
		<div class="controls">
			<input type="text" name="skje2" class="span4 skje2" value="<?php echo ($list["skje2"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">收款日期2：</label>
		<div class="controls">
			<input type="date" name="skrq2" id="skrq2"  class="span4" value="<?php echo ($list["skrq2"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">收款方式2：</label>
		<div class="controls">
			<input type="text" name="skfs2" id="skfs2"  class="span4" value="<?php echo ($list["skfs2"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">客户卡号2：</label>
		<div class="controls">
			<input type="text" name="khcard2" id="khcard2"  class="span4" value="<?php echo ($list["khcard2"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">POS单凭证号2：</label>
		<div class="controls">
			<input type="text" name="pos_pzh2" id="pos_pzh2"  class="span4" value="<?php echo ($list["pos_pzh2"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">收据编号2：</label>
		<div class="controls">
			<input type="text" name="sjnum2" id="sjnum2"  class="span4" value="<?php echo ($list["sjnum2"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">收款金额3：</label>
		<div class="controls">
			<input type="text" name="skje3" class="span4 skje3" value="<?php echo ($list["skje3"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">收款日期3：</label>
		<div class="controls">
			<input type="date" name="skrq3" id="skrq3"  class="span4" value="<?php echo ($list["skrq3"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">收款方式3：</label>
		<div class="controls">
			<input type="text" name="skfs3" id="skfs3"  class="span4" value="<?php echo ($list["skfs3"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">客户卡号3：</label>
		<div class="controls">
			<input type="text" name="khcard3" id="khcard3"  class="span4" value="<?php echo ($list["khcard3"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">POS单凭证号3：</label>
		<div class="controls">
			<input type="text" name="pos_pzh3" id="pos_pzh3"  class="span4" value="<?php echo ($list["pos_pzh3"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">收据编号3：</label>
		<div class="controls">
			<input type="text" name="sjnum3" id="sjnum3"  class="span4" value="<?php echo ($list["sjnum3"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">应付金额：</label>
		<div class="controls">
			<input type="text" name="yfje" id="yfje"  class="span4" value="<?php echo ($list["yfje"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">中介奖励：</label>
		<div class="controls">
			<input type="text" name="jjrjl" id="jjrjl"  class="span4" value="<?php echo ($list["jjrjl"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">请佣金额1：</label>
		<div class="controls">
			<input type="text" name="qyje1"  class="span4 qyje1" value="<?php echo ($list["qyje1"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">请佣日期1：</label>
		<div class="controls">
			<input type="date" name="qyrq1" id="qyrq1"  class="span4" value="<?php echo ($list["qyrq1"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">打款日期1：</label>
		<div class="controls">
			<input type="text" name="dkrq1" class="span4 dkrq1" value="<?php echo ($list["dkrq1"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">请佣金额2：</label>
		<div class="controls">
			<input type="text" name="qyje2" class="span4 qyje2" value="<?php echo ($list["qyje2"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">请佣日期2：</label>
		<div class="controls">
			<input type="date" name="qyrq2" class="span4 qyrq2" value="<?php echo ($list["qyrq2"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">打款日期2：</label>
		<div class="controls">
			<input type="text" name="dkrq2" id="dkrq2"  class="span4" value="<?php echo ($list["dkrq2"]); ?>" data-rule-required="true">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">总付款：</label>
		<div class="controls">
			<input type="text" name="zfk" readonly class="span4 zfk" value="<?php echo ($list["zfk"]); ?>">
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<select name="isfk" class="isfk">
				...
				<option value="1" <?php if($list[isfk] == 1): ?>selected<?php endif; ?>>否</option>
				<option value="2" <?php if($list[isfk] == 2): ?>selected<?php endif; ?>>是</option>
			</select>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<select name="istf" class="istf">
				...
				<option value="1" <?php if($list[istf] == 1): ?>selected<?php endif; ?>>否</option>
				<option value="2" <?php if($list[istf] == 2): ?>selected<?php endif; ?>>是</option>
			</select>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="remark" id="remark"  class="span4" value="<?php echo ($list["remark"]); ?>" data-rule-required="true">
		</div>
	</div>
  ...
  <script>
	$('.lp').chosen({search_contains: true,width:"220px",allow_single_deselect : true}).on("change", function (evt, params) {
		...
		$.ajax({
			type:'post',
			url:"<?php echo U('ServiceUser/ajax_zy',array('token'=>$token));?>",
			dataType:"json",
			data:{"lpid":lpid},
	...
	$('.jjgs').chosen({search_contains: true,width:"220px"}).on("change", function (evt, params) {
		...
		$.ajax({
			type:'post',
			url:"<?php echo U('ServiceUser/ajax_jjr',array('token'=>$token));?>",
			dataType:"json",
