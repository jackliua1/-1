...
<!-- ----------------------------------------------------------------------------------------------------------------------------------------------------- -->
          ...
          <div class="tleft">
            <?php if(is_array($fun)): $k = 0; $__LIST__ = $fun;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tleft): $mod = ($k % 2 );++$k;?><table>
              ...
              <?php if(is_array($tleft)): $i = 0; $__LIST__ = $tleft;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i; if(($mod) == "0"): ?><tr>
                      <td class="w1"><?php echo ($list["name"]); ?></td>
                      <td class="w2"><?php echo ($list["info"]); ?>--</td>
                      <td class="w3"><input type="button" token="<?php echo (session('token')); ?>" id="<?php echo ($list["id"]); ?>" 
                        <?php if($list['gid'] > session('gid')): ?>class="default"
                        <?php else: ?>
                          <?php if(in_array($list['funname'],$check)): ?>flag="true" class="status_on status"<?php endif; ?> <?php if(in_array($list['funname'],$check) != 1): ?>flag="false" class="status_off status"<?php endif; endif; ?>
                        /></td>
          ...
          <div class="tright">
            <?php if(is_array($fun)): $k = 0; $__LIST__ = $fun;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tright): $mod = ($k % 2 );++$k;?><table>
                <tr class="title"><td colspan="3">VIP<?php echo $k-1;?>可以使用的功能</td></tr>
                <tr>
                  <th class="w1">功能</th>
                  <th class="w2">回复关键词</th>
                ...
                <?php if(is_array($tright)): $i = 0; $__LIST__ = $tright;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i; if(($mod) == "1"): ?><tr>
                      <td class="w1"><?php echo ($list["name"]); ?></td>
                      <td class="w2"><?php echo ($list["info"]); ?></td>
                      <td class="w3"><input type="button" token="<?php echo (session('token')); ?>" id="<?php echo ($list["id"]); ?>" <?php if($list['gid'] > session('gid')): ?>class="default"<?php else: if(in_array($list['funname'],$check)): ?>flag="true" class="status_on status"<?php endif; ?> <?php if(in_array($list['funname'],$check) != 1): ?>flag="false" class="status_off status"<?php endif; endif; ?>/></td>
                    </tr><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                  <?php
 if(count($tright)%2 == 1){ echo '<tr>
                      <td class="w1"></td>
                      <td class="w2"></td>
                      <td class="w3"></td>
                    </tr>'; } ?>
