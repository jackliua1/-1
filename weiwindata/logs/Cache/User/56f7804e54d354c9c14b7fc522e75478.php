    ...
    <div id="nav">
        ...
        <div class="account">
            ...
            <ul>
                ...
                <li>会员余额：<?php echo ($thisUser["moneybalance"]); ?></li>
                <li>
                    VIP有效时间：
              ...
              <TBODY>
                <TR></TR>                
                 <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><TR>
					  <TD style="text-align:center;"><p><a href="<?php echo U('Function/index',array('id'=>$vo['id'],'token'=>$vo['token']));?>" title="点击进入功能管理"><img src="<?php echo ($vo["headerpic"]); ?>" width="40" height="40"></a></p><p><?php echo ($vo["wxname"]); ?></p></TD>
					  <!-- <TD align="center"><?php if($_SESSION['gid']>1){echo $_SESSION['gid']-1;}else{echo 0;} ?></TD>
					  <TD><p>创建时间:<?php echo (date("Y-m-d",$vo["createtime"])); ?></p><p>到期时间:<?php echo (date("Y-m-d",$viptime)); ?></p><p><a   href="<?php echo U('Alipay/vip');?>" id="smemberss" class="green"><em>升降级vip续费</em></a></p></Td> -->
				 ...
				 <TD class="norightborder">　<a  class="btnGreens" href="<?php echo U('Index/edit',array('id'=>$vo['id']));?>">编辑</a>　<a  class="btnGreens" href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Index/del',array('id'=>$vo['id']));?>');">删除</a>　
					  <a href="<?php echo U('Function/index',array('id'=>$vo['id'],'token'=>$vo['token']));?>"  style="
    background: #25B6DA;
" class="btnGreens" >功能管理</a>
					  <a href="<?php echo U('Home/Index/help',array('id'=>$vo['id'],'token'=>$vo['token']));?>" style="background:#F00" class="btnGreens" >API接口</a>
					  </TD>
