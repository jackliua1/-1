...
<div class="content">
          ...
          <div class="cLine">
    <!-- <div class="alert">
    <p><span class="bold">客户信息管理：</span>添加添加客户信息。添加地址：<a href="/index.php?g=Chat&m=Login&a=index"><?php echo C('site_url');?>/index.php?g=Chat&m=Login&a=index</a></p>
    </div> -->
</div>
          ...
          <div class="cLine">
            <div class="pageNavigator left">
               ...
               <!--   <span class="btnGrayS vm bigbtn" id="import">
                ...
                &nbsp;
                <a href="<?php echo U('ServiceUser/outexc',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
            ...
            <!-- <td>
              ...
              <?php else: ?>
                <span class="label"> <?php echo (date('Y-m-d',$list['yxTime'])); ?></span><?php endif; ?>
						...
						<td>
							<a href="<?php echo U('ServiceUser/edit1',array('id'=>$list['ID'],'token'=>$list['Token']));?>" class="btn">编辑</a>
