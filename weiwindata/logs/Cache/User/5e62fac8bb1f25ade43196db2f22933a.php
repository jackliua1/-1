...
<div class="cLineB">
  ...
  <form action="" method="post" class="form-horizontal form-validate" novalidate="novalidate">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="rewardname" id="title" maxlength="10" class="span4" value="<?php echo ($list["rewardname"]); ?>" data-rule-required="true"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		<label for="title" class="control-label">奖励类型</label>
		<div class="controls">
			<input type="text" name="rewardparam" id="title" maxlength="10" class="span4" value="<?php echo ($list["rewardparam"]); ?>" data-rule-required="true">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="rewardamount" id="title" maxlength="10" class="span4" value="<?php echo ($list["rewardamount"]); ?>" data-rule-required="true"><span class="maroon">*</span><span class="help-inline">单位为元或百分数</span>
		</div>
	</div>
	<div class="control-group">
		<label for="Tel" class="control-label">状态描述：</label>
		<div class="controls">
			<input type="text" name="paraminstr" id="paraminstr" class="span4" data-rule-required="true" value="<?php echo ($list["paraminstr"]); ?>" style="width:500px;"><span class="maroon">
