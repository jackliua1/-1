...
<td>
  <?php if(is_array($lparr)): $i = 0; $__LIST__ = $lparr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lp): $mod = ($i % 2 );++$i; if($lp['id'] == $vo['lpid']): echo ($lp['LouPanTitle']); endif; endforeach; endif; else: echo "" ;endif; ?>
</td>
