...
<div class="content">
  ...
  <div class="cLineD"></div>
      ...
      <div class="cLine">
        <div class="ftip" style="margin:0 auto">生成项目总监和驻场经理的邀请码</div>
      </div>
  ...
  <div class="cLine">
    <div class="pageNavigator left">
      <a href="<?php echo U('Wechat_behavior/invitationcodeadd',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
          <img src="tpl/User/default/common/images/text.png" class="vm">新增邀请码
      </a>
    </div>
    <div class="clr"></div>
  </div>
  ...
  <div class="msgWrap">
    <form method="post" action="" id="info">
      ...
      <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
        <thead>
          <tr>
            <th class="span3">所属项目</th>
            <th class="span3">适用类型</th>
            <th class="span3">邀请码</th>
            <th class="span3">状态</th>
            <th class="span3">有效时间</th>
            <th class="span3">操作</th>
            <!-- <th class="span3">是否过期</th> -->
          </tr>
        </thead>
        <tbody>
          <?php if($list == null): ?><tr>
            <td colspan="6" style="text-align:center; height:30px;"><strong>暂无邀请码</strong></td>
            </tr>
          <?php else: ?>
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
              <span class="label"> 
                <?php echo (date("Y-m-d",$list['endtime'])); ?>
              </span>
            </td>
            <td>
              <a href="<?php echo U('Wechat_behavior/invitationcodeedit',array('id'=>$list['id'],'token'=>$list['token']));?>" class="btn">编辑</a>
              &nbsp;<a href="<?php echo U('Wechat_behavior/invitationcodedel',array('id'=>$list['id'],'token'=>$list['token']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn">删除</a>
            </td>
