...
<div class="content">
  ...
  <div class="cLineD"></div>
      ...
      <div class="cLine">
        <div class="ftip" style="margin:0 auto">会员类别设置</div>
      </div>
  ...
  <div class="cLine">
    <div class="pageNavigator left">
       <a href="<?php echo U('Wechat_behavior/agenttypeadd',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
            <img src="tpl/User/default/common/images/text.png" class="vm">新增类别
        </a>
    </div>
    <div class="clr"></div>
  </div>
  ...
  <div class="msgWrap">
    <form method="post" action="" id="info">
      ...
      <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
        <thead>
          <tr>
            <th class="span3">类别名称</th>
            <th class="span3">是否有公司</th>
        ...
        <tbody>
          <?php if($list == ''): ?><tr>
            <td colspan="4" style="text-align:center; height:30px;"><strong>暂无会员类别</strong></td>
            </tr>
          <?php else: ?>
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
            <td><?php echo ($list['typename']); ?></td>
            <td>
              <span class="label"><?php if($list['iscompany'] == 0): ?>否<?php else: ?>是<?php endif; ?></span>
            </td>
            
            <td><?php echo ($list['sort']); ?></td>
            <td>
              <a href="<?php echo U('Wechat_behavior/agenttypeOfModule',array('id'=>$list['id'],'token'=>$list['token']));?>" class="btn">编辑</a>
              &nbsp;<a href="<?php echo U('Wechat_behavior/agenttypeOfDel',array('id'=>$list['id'],'token'=>$list['token']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn">删除</a></a>
            </td>
