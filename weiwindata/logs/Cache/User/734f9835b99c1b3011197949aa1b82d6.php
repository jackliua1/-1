...
<div class="content">
  ...
  <div class="cLineD"></div>
      ...
      <div class="cLine">
        <div class="ftip" style="margin:0 auto">设置项目每个阶段的奖励</div>
      </div>
  ...
  <div class="cLine">
    <div class="pageNavigator left">
       <a href="<?php echo U('Wechat_behavior/rewardinfoadd',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
  ...
  <div class="msgWrap">
    <form method="post" action="" id="info">
      ...
      <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tbody>
          <?php if($list == ''): ?><tr>
            <td colspan="4" style="text-align:center; height:30px;"><strong>暂无项目奖励设置</strong></td>
            </tr>
          <?php else: ?>
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
            <td><?php echo ($list['LouPanTitle']); ?></td>
            <td><span class="label"> <?php echo ($list['salesstatus']); ?></span></td>
            <td><span class="label"> <?php echo ($list['rewardname']); ?></span></td>
            
            <td>
              <a href="<?php echo U('Wechat_behavior/rewardinfoOfModule',array('id'=>$list['infoid'],'token'=>$list['token']));?>" class="btn">编辑</a>
              &nbsp;<a href="<?php echo U('Wechat_behavior/rewardinfoOfDel',array('id'=>$list['infoid'],'token'=>$list['token']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn">删除</a></a>
            </td>
