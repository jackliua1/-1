...
<div class="content">
          <div class="cLineB"><h4>项目总监维护</h4></div>
			...
			<div class="msgWrap form">
				<ul id="tags" style="width:100%">
					<li class="selectTag">
						<a href="?g=User&m=Message&a=index">项目总监</a> 
					</li>
					<!-- <li>
						<a href="?g=User&m=Message&a=index2">意向客户分配</a> 
					</li> -->
          ...
          <div class="cLine">
            <div class="pageNavigator left">
                <a href="<?php echo U('Message/addanchang',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
                    <img src="tpl/User/default/common/images/text.png" class="vm">新增总监
                </a>
               <!--  &nbsp;&nbsp;
                <a class="btnGrayS vm bigbtn" id="import">
                    <img src="tpl/User/default/common/images/text.png" class="vm">导入案场
                </a> -->
             ...
             <script type="text/javascript">
                ...
                hide();
                window.location="<?php echo U('Message/index');?>";
                });
                  //点击取消
              ...
              $("#dvMsk").remove();
               ...
               <div id="showDiv" style="display:none;">
                 ...
                 <div class="imtem" style="width:300px;">
                  <a href="tpl/User/default/common/tmp/项目总监.xls"><button class="btuFile"  id="" style="margin-top:5px;margin-left:10px;padding:5px;">下载模板</button></a>
                  </div>
                  <form action="<?php echo U('Message/excinac',array('token'=>$token));?>" method="post" enctype="multipart/form-data">
                   ...
                   <table border="0" style="margin-top:10px;" >
                    ...
                    <tr height="50px;">
                      ...
                      <td style="text-align:center;">
                         <a href="<?php echo U('Message/index');?>" id="close" ><input type="button" style="width:100px;height:30px;" value="取消" /></a>
                      </td>
                    </tr>
                    </table>
                  </center>
           ...
           <input name="wxid" type="hidden" value="gh_423dwjkewad">
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
             ...
             <tr>                       
				...
				<tbody>
					<?php if($list == ''): ?><tr>
						<td colspan="6" style="text-align:center; height:30px;"><strong>暂无项目总监信息</strong></td>
						</tr>
					<?php else: ?>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><span class="label"> <?php echo (date('Y-m-d',$list['addTime'])); ?></span></td>
						<td>
							<a href="<?php echo U('Message/edit',array('id'=>$list['ID'],'token'=>$list['Token']));?>" class="btn">修改</a>
							&nbsp;<a href="<?php echo U('Message/del',array('id'=>$list['ID'],'token'=>$list['Token']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn">删除</a></a>
						</td>
