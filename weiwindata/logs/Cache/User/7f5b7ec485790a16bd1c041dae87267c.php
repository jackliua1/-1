...
<div class="cLineB">
  <h4>新增邀请码</h4><a href="<?php echo U('Wechat_behavior/invitationcode');?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div> 
  ...
  <form action="" method="post" class="form-horizontal form-validate" novalidate="novalidate">
	...
	<div class="control-group">
		<label for="title" class="control-label" style="width:160px;">适用类型：</label>
			<label for="zy"><input type="radio" value="0" name="type" id="zy" checked>置业顾问</label>&nbsp;&nbsp;
			<label for="ac"><input type="radio" value="1" name="type" id="ac">案场经理　</label>&nbsp;&nbsp;
	</div>
	<div class="control-group">
		<label for="SrTime" class="control-label">邀请码：</label>
		<div class="controls">
			<input type="text" name="code" id="code" class="span4" data-rule-required="true" >
	...
	<div class="control-group">
		...
		<div class="controls">
			<label for="no"><input type="radio" value="0" name="status" id="no" checked>无效</label>&nbsp;&nbsp;
			<label for="yes"><input type="radio" value="1" name="status" id="yes">有效</label>&nbsp;&nbsp;
		</div>
	</div>
	<div class="control-group">
		<label for="SrTime" class="control-label">有效时间：</label>
		<div class="controls">
			<input name="endtime" id="intro" class="px"  rows="5" value="" onClick="WdatePicker()"/>
		</div>
	</div>
	<div class="form-actions">
		<button id="bsubmit" type="submit" data-loading-text="提交中..." class="btnGreen" onclick="return abc();">生成</button>
	</div>
