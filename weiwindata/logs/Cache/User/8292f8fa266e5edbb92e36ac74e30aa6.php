            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <TBODY>
				...
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "没有找到数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
  <?php if(is_array($lparr)): $i = 0; $__LIST__ = $lparr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lp): $mod = ($i % 2 );++$i; if($lp['id'] == $vo['lpid']): echo ($lp['LouPanTitle']); endif; endforeach; endif; else: echo "没有找到数据" ;endif; ?>
</td>
