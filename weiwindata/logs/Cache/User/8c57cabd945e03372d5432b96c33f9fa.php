...
<div class="cLineB">
  <h4>新增奖励类型</h4><a href="<?php echo U('Wechat_behavior/rewardparam');?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div> 
  ...
  <form action="" method="post" class="form-horizontal form-validate" novalidate="novalidate">
	...
	<div class="control-group">
		<label for="title" class="control-label">奖品名称</label>
		<div class="controls">
			<input type="text" name="rewardname" id="title" maxlength="10" class="span4" value="<?php echo ($reward["rewardname"]); ?>" data-rule-required="true"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		<label for="title" class="control-label">奖励类型</label>
		<div class="controls">
			<input type="text" name="rewardparam" id="title" maxlength="10" class="span4" value="<?php echo ($reward["rewardparam"]); ?>" data-rule-required="true">
			<span class="maroon">*</span><span class="help-inline">填0为佣金类型以百分比计算，1为面值类型以实际金额计算</span>
		</div>
	</div>
	<div class="control-group">
		<label for="title" class="control-label">奖励金额/百分比</label>
		<div class="controls">
			<input type="text" name="rewardamount" id="title" maxlength="10" class="span4" value="<?php echo ($reward["rewardamount"]); ?>" data-rule-required="true"><span class="maroon">*</span><span class="help-inline">单位为元或百分数</span>
		</div>
	</div>
	<div class="control-group">
		<label for="Tel" class="control-label">状态描述：</label>
		<div class="controls">
			<input type="text" name="paraminstr" id="paraminstr" class="span4" data-rule-required="true" value="<?php echo ($reward["paraminstr"]); ?>" style="width:500px;"><span class="maroon">
			*</span><span class="help-inline"></span>
		</div>
	</div>
   <div class="form-actions">
			<button id="bsubmit" type="submit" data-loading-text="提交中..." class="btnGreen">保存</button>　<a href="<?php echo U('Wechat_behavior/rewardparam');?>" class="btnGray vm">取消</a>
		</div>
</form>
  </div> 
