...
<div class="cLineB">
  <h4>项目总监信息维护</h4><a href="<?php echo U('Message/index');?>" class="right btnGrayS vm">返回</a>
 </div> 
  <div class="msgWrap bgfc">
  <form action="" method="post" class="form-horizontal form-validate" novalidate="novalidate">
	<input type="hidden" name="ID" value="<?php echo ($list["ID"]); ?>">
	<div class="control-group">
		<label for="Name" class="control-label">项目总监姓名：</label>
		<div class="controls">
	...
	<div class="control-group">
		<label for="Tel" class="control-label">项目总监电话：</label>
		<div class="controls">
	...
	<div class="control-group">
		...
		<div class="controls">
			<?php if($list['BDTime'] == 0): ?><input type="text" name="BDTime" id="BDTime" class="span4" data-rule-required="true" value=""  onClick="WdatePicker()">
			<?php else: ?>
				<input type="text" name="BDTime" id="BDTime" class="span4" data-rule-required="true" value="<?php echo (date('Y-m-d',$list["BDTime"])); ?>"><?php endif; ?>
			
		</div>
	</div> -->
   <div class="form-actions">
			<button id="bsubmit" type="submit" data-loading-text="提交中..." class="btnGreen">保存</button>　<a href="<?php echo U('Message/index');?>" class="btnGray vm">取消</a>
		</div>
</form>
  </div> 
  <script>
