    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody>
       ...
       <!-- <tr>
        <th><span class="red">*</span>统一邮费：</th> 
        <td><input type="text" name="postage" value="<?php echo ($setting["postage"]); ?>" class="px"/>  元</td> 
       </tr> -->
       <tr>
        <th><span class="red">*</span>积分兑换：</th> 
        <td><input type="text" name="score" value="<?php echo ($setting["score"]); ?>" class="px"/>积分=0.1元</td> 
       </tr>
