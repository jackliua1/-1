...
<div class="cLineB">
  <h4>意向客户修改</h4><a href="<?php echo U('Message/index2');?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div> 
  ...
  <form action="" method="post" class="form-horizontal form-validate" novalidate="novalidate">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="Name" id="title" maxlength="10" class="span4" value="<?php echo ($list["Name"]); ?>" data-rule-required="true"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		<label for="Tel" class="control-label">客户电话：</label>
		<div class="controls">
			<input type="text" name="Tel" id="Tel" class="span4" data-rule-required="true" value="<?php echo ($list["Tel"]); ?>"><span class="maroon">*</span><span class="help-inline">请填写正确的手机号码</span>
		</div>
	</div>
	<div class="control-group">
		<label for="LouPanTitle" class="control-label">意向项目：</label>
		<div class="controls">
			<select name="Uid" >
	...
	<div class="control-group">
		<label for="JJ_id" class="control-label">会员：</label>
		<div class="controls">
			<select name="JJ_id" >
		        <?php if(is_array($jjr)): $i = 0; $__LIST__ = $jjr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$jjr): $mod = ($i % 2 );++$i;?><option value="<?php echo ($jjr["ID"]); ?>" <?php if($jjr['ID'] == $list['JJ_id']): ?>selected<?php endif; ?>><?php echo ($jjr["Name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		      </select>
		</div>
	</div>
	<div class="control-group">
		<label for="zy_id" class="control-label">置业顾问：</label>
		<div class="controls">
			<select name="zy_id" >
				<option value="0" >--请选择--</option>
				<?php if(is_array($zy)): $i = 0; $__LIST__ = $zy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zy): $mod = ($i % 2 );++$i;?><option value="<?php echo ($zy["ID"]); ?>" <?php if($zy['ID'] == $list['zy_id']): ?>selected<?php endif; ?>><?php echo ($zy["Name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		      </select>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<select name="Stutas" style="width:100px;height:30px;">
				<?php if(is_array($status)): $i = 0; $__LIST__ = $status;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="$vo['id']" <?php if($list['Stutas'] == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo["salesstatus"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="SrTime" id="SrTime" class="span4" data-rule-required="true" value="<?php echo (date('Y-m-d',$list["SrTime"])); ?>" readonly>
		</div>
	</div>
	<div class="control-group">
		<label for="yxTime" class="control-label">有效日期：</label>
		<div class="controls">
			<?php if($list["yxTime"] == 0): ?><input type="text" name="yxTime" id="yxTime" class="span4" data-rule-required="true" value=""  onClick="WdatePicker()">
			<?php else: ?>
				<input type="text" name="yxTime" id="yxTime" class="span4" data-rule-required="true" value="<?php echo (date('Y-m-d',$list["yxTime"])); ?>" readonly><?php endif; ?>
		</div>
	</div>
	<!-- <div class="control-group">
		<label for="userName" class="control-label">到场时间：</label>
		<div class="controls">
	...
	<div class="control-group">
		<label for="userName" class="control-label">认筹时间：</label>
		<div class="controls">
			<input type="text" name="userName" id="userName" class="span4" data-rule-required="true" value="<?php echo ($serviceUser["userName"]); ?>"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		<label for="userName" class="control-label">认购时间：</label>
		<div class="controls">
			<input type="text" name="userName" id="userName" class="span4" data-rule-required="true" value="<?php echo ($serviceUser["userName"]); ?>"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		<label for="userName" class="control-label">签约时间：</label>
		<div class="controls">
			<input type="text" name="userName" id="userName" class="span4" data-rule-required="true" value="<?php echo ($serviceUser["userName"]); ?>"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
   ...
   <div class="form-actions">
			<button id="bsubmit" type="submit" data-loading-text="提交中..." class="btnGreen">保存</button>　<a href="<?php echo U('Message/index2');?>" class="btnGray vm">取消</a>
		</div>
</form>
  </div> 
