...
<div class="content">
          <div class="cLineB"><h4>佣金充值</h4></div>

      <div class="msgWrap form">
        <ul id="tags" style="width:100%">
          <li class="selectTag">
            <a href="?g=User&m=Capital&a=index">佣金充值</a> 
          </li>
          <!-- <li>
        ...
        <div class="clr" style="height:1px;background:#eee;margin-bottom:20px;"></div>
          ...
          <div class="cLine">
            <div class="pageNavigator left">
                <a href="<?php echo U('Capital/addmoney',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
                    <img src="tpl/User/default/common/images/text.png" class="vm">充值
                </a>
                <!-- &nbsp;&nbsp;
          ...
          <input name="delall" type="hidden" value="del">
           <input name="wxid" type="hidden" value="gh_423dwjkewad">
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
             <tr>                      
      				<th class="span1">充值项目</th>
              <th class="span3">充值总额</th>
              <th class="span3">已发总额</th>
              <th class="span3">剩余总额</th>
              <th class="span3">操作</th>
      			</tr>
			  </thead>
				<tbody>
					<?php if($list == ''): ?><tr>
						<td colspan="6" style="text-align:center; height:30px;"><strong>暂无充值记录</strong></td>
						</tr>
					<?php else: ?>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
            <td><?php echo ($list['LouPanTitle']); ?></td>
            <td><?php echo ($list['allmoney']); ?></td>
            <td><?php echo ($list['rewardamount']); ?></td>
						<td><?php echo (($list['residue'])?($list['residue']):$list['allmoney']); ?></td>
						<td>
							<a href="<?php echo U('Capital/detailmoney',array('lpid'=>$list['lpid'],'token'=>$list['token']));?>" class="btn">充值明细</a>
						</td>
