...
<div class="content">
        ...
        <div class="msgWrap form">
          <ul id="tags" style="width:100%">
            <li>
              <a href="?g=User&m=Expert&a=index&token=<?php echo ($list[0]['token']); ?>">达人基础信息</a> 
            </li>
            <li class="selectTag">
              <a>达人参与活动</a> 
            </li>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                <tr>
                  ...
                  <th width="15%">达人电话</th>
                  <th width="25%">活动名称</th>
        					<th width="15%">获得奖品数量</th>
        					<th width="15%">已领取数量</th>
        					<th class="norightborder" width="15%">操作</th>
                </tr>
              </thead>
              <tbody>
              <?php if($list == null): ?><tr>
                  <td colspan="6" style="text-align:center; height:30px;"><strong>暂无达人参与活动信息</strong></td>
                </tr><?php endif; ?>
    			   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                  <td><?php echo ($list["expertname"]); ?></td>
                  <td><?php echo ($list["expertphone"]); ?></td>
                  <td><?php echo ($list["sharename"]); ?></td>
				          <td><?php echo ($list["hasreward"]); ?></td>
                  <td><?php echo ($list["lqreward"]); ?></td>
                  
                  <td class="norightborder">
    						<a href="<?php echo U('Expert/edites',array('id'=>$list['id'],'token'=>$list['token']));?>">修改</a>&nbsp;&nbsp;
                <a href="<?php echo U('Expert/deles',array('id'=>$list['id'],'token'=>$list['token']));?>"  onclick="return(confirm('确定要删除吗？'))">删除</a>
    				   </td>
