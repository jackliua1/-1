...
<script type="text/javascript" src="<?php echo RES;?>/js/Province.js"></script>
...
<div class="content">
          <div class="cLineB"><h4>项目信息维护</h4><a href="<?php echo U('Wechat_group/groups');?>"  class="right btnGrayS vm">返回</a></div>
          ...
          <div class="msgWrap form">
            <TABLE class="userinfoArea" border="0" cellSpacing="0" cellPadding="0" width="100%">
                          <TR>
                            ...
                            <TD valign="top">
                               ...
                               <select name="province" id="province" style="height:30px;">
                                    <?php if(is_array($pro)): $i = 0; $__LIST__ = $pro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["code"]); ?>" <?php if($thisGroup[0]['pro_code'] == $vo['code']): ?>selected<?php endif; ?>><?php echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                               </select>&nbsp;&nbsp;
                               <label for="city" style="font-size:16px;">市 </label>
                              <select name="city" id="city" style="height:30px;">
                                <option value="0">--请选择--</option>
                                <?php if($thisGroup[0]['cit_code'] == ''): if(is_array($cit)): $i = 0; $__LIST__ = $cit;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["code"]); ?>"><?php echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php else: ?>
                                  <option value="<?php echo ($thisGroup[0]['cit_code']); ?>" selected><?php echo ($thisGroup[0]['cit_name']); ?></option><?php endif; ?>
                              </select>&nbsp;&nbsp;
                              <label for="area" style="font-size:16px;">区 </label>
                                <select name="area" id="area" style="height:30px;">
                                  <option value="0">--请选择--</option>
                                  <?php if($thisGroup[0]['are_code'] == ''): if(is_array($are)): $i = 0; $__LIST__ = $are;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["code"]); ?>"><?php echo ($vo['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                  <?php else: ?>
                                    <option value="<?php echo ($thisGroup[0]['are_code']); ?>" selected><?php echo ($thisGroup[0]['are_name']); ?></option><?php endif; ?>
                                </select>
                            <br />
                            ...
                            // 选择省份获取城市信息
                              $('#province').change(function(){
                                ...
                                $.ajax({
                                  type:"post",
                                  url:"<?php echo U('Wechat_group/showcity');?>",
                                  dataType:"json",
                              ...
                              $('#city').change(function(){
                                ...
                                $.ajax({
                                  type:"post",
                                  url:"<?php echo U('Wechat_group/showarea');?>",
                                  dataType:"json",
                ...
                <TR>
                  ...
                  <TD><input class="px"  name="LouPanTitle" id="name" value="<?php echo ($thisGroup[0]['LouPanTitle']); ?>" style="width:200px;"  /></TD>
                </TR>
                <TR>
                  <TH valign="top"><label for="pic">项目介绍：</label></TH>
                  <TD>
                    <!-- <textarea class="px" name="projectinfo" id="projectinfo" style="width:400px;resize:none;"  ><?php echo ($thisGroup[0]['projectinfo']); ?></textarea> -->
                  <script id="editor" name="projectinfo" type="text/plain" style="width:500px;height:300px;"><?php echo (htmlspecialchars_decode($thisGroup[0]['projectinfo'])); ?></script></TD>
                </TR>
                <TR>
                  <TH valign="top"><label for="pic">项目图片：</label></TH>
                  <TD>
                    <img id="pic1_src" src="<?php if($thisGroup[0]['LouPanUpLoad'] == ''): ?>/tpl/User/default/common/images/lp/fd039245d688d.jpg<?php else: echo ($thisGroup[0]['LouPanUpLoad']); endif; ?>" width="373px" > 
                    <br />
                    <input class="px"  name="LouPanUpLoad" value="<?php if($thisGroup[0]['LouPanUpLoad'] == ''): ?>/tpl/User/default/common/images/lp/fd039245d688d.jpg<?php else: echo ($thisGroup[0]['LouPanUpLoad']); endif; ?>" id="pic1" style="width:363px;"  />
                    <br />
                      <a href="###" onclick="upyunPicUpload('pic1',700,420,'<?php echo ($token); ?>')" id="upload" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic1')">预览</a>&nbsp;
                  </TD>
                </TR>
				<TR>
                  <TH valign="top"><label for="pic">对接人姓名：</label></TH>
                  <TD><input class="px"  name="djname" id="djname" value="<?php echo ($thisGroup[0]['djname']); ?>" style="width:200px;" /></TD>
                </TR>
				<TR>
                  <TH valign="top"><label for="pic">对接人电话：</label></TH>
                  <TD><input class="px"  name="djtel" id="djtel" value="<?php echo ($thisGroup[0]['djtel']); ?>" style="width:200px;" /></TD>
                </TR>
                <TR>
                  <TH valign="top"><label for="pic">佣金：</label></TH>
                  <TD><input class="px"  name="commission" id="commission" value="<?php echo ($thisGroup[0]['commission']); ?>" style="width:200px;" /></TD>
                </TR>
                <TR>
                  <TH valign="top"><label for="pic">激励：</label></TH>
                  <TD><textarea class="px" name="encourage" id="encourage" style="width:400px;resize:none;" ><?php echo ($thisGroup[0]['encourage']); ?></textarea></TD>
                </TR>

                <TR>
                  <TH valign="top"><label for="pic">排序：</label></TH>
                  <TD><input class="px"  name="houseSort" id="name" value="<?php echo ($thisGroup[0]['houseSort']); ?>" style="width:200px;"  />
                    <span>&nbsp;&nbsp;*数值越大排位越高</span>
                  </TD>
                </TR>
				<TR>
                  <TH valign="top"><label for="pic">报备保护期：</label></TH>
                  <TD><input class="px"  name="houseSortse" id="name" value="<?php echo ($thisGroup[0]['houseSortse']); ?>" style="width:200px;"  />&nbsp;&nbsp;天
                    <span>&nbsp;&nbsp;*客户信息不会改变</span>
                  </TD>
                </TR>
                  <input type="hidden" name="type" value="<?php echo ($thisGroup['type']); ?>">
                  <input type="hidden" name="id" value="<?php echo ($thisGroup['id']); ?>">
                <TR>
                  <TH></TH>
                  <TD><?php if($thisGroup): ?><input type="hidden" name="id" value="<?php echo ($thisGroup['id']); ?>" /><?php endif; ?>
                    <input type="submit" value="保存" name="sbmt" class="btnGreen left">&nbsp;&nbsp;<a href="<?php echo U('Wechat_group/groups');?>" class="btnGray vm">取消</a></TD>
                </TR>
              </TBODY>
            </TABLE>
