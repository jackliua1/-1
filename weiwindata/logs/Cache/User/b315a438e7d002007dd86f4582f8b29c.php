...
<div id="Frame">
    ...
    <div class="Menu">
        <div class="TwoMenu">
            ...
            <div id="TwoMenu-01" <?php if(in_array(MODULE_NAME,array('Function','Areply','Text','Voiceresponse','Call','Company','Other','Diymen','Requerydata','Index','Printer','Api','Panorama'))){ ?>style="display:block;" <?php }else{ ?>style="display:none;"<?php } ?> >
...
<div class="Menu">
        <div class="ThreeMenu">
            <div class="contab" <?php if(in_array(MODULE_NAME,array('Function','Areply','Text','Voiceresponse','Call','Company','Other','Requerydata','Index','Printer','Panorama'))){ ?>style="display:block;" <?php }else{ ?>style="display:none;"<?php } ?> >
...
<div class="cLineB">
  <h4>佣金信息维护</h4><a href="<?php echo U('Share/reward',array('token'=>$_GET['token']));?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div> 
  ...
  <form action="" method="post" class="form-horizontal form-validate" novalidate="novalidate">
	...
	<!-- <div class="control-group">
		...
		<div class="controls">
			<input type="text" name="customname" id="customname" maxlength="10" class="span4" value="<?php echo ($list["customname"]); ?>" data-rule-required="true">
		</div>
			<?php echo ($list["customname"]); ?>
	</div> -->
	<!-- <div class="control-group">
		<label for="loupanname" class="control-label">意向项目：</label>
		<div class="controls">
			<input type="text" name="loupanname" id="loupanname" class="span4" data-rule-required="true" value="<?php echo ($list["loupanname"]); ?>" readonly>
		</div>
			<?php echo ($list["loupanname"]); ?>
	</div> -->
	<div class="control-group">
		<label for="Name" class="control-label">经纪人姓名：</label>
<!-- 		<div class="controls">
			<input type="text" name="Name" id="Name" class="span4" data-rule-required="true" value="<?php echo ($list["Name"]); ?>" readonly>
		</div>
 -->			<?php echo ($list["Name"]); ?>
	</div>
<!-- 	<div class="control-group">
		<label for="statusname" class="control-label">销售状态：</label>
		<div class="controls">
			<input type="text" name="statusname" id="statusname" class="span4" data-rule-required="true" value="<?php echo ($list["statusname"]); ?>" readonly>
		</div>
			<?php echo ($list["statusname"]); ?>
	</div> -->
<!-- 	<div class="control-group">
		<label for="rewardname" class="control-label">奖励名称：</label>
		<div class="controls">
			<input type="text" name="rewardname" id="rewardname" class="span4" data-rule-required="true" value="<?php echo ($list["rewardname"]); ?>" readonly>
		</div>
			<?php echo ($list["rewardname"]); ?>
	</div> -->

	<div class="control-group">
		<label for="rewardamount" class="control-label">奖励金额：</label>
		<!-- <div class="controls">
			<input type="text" name="rewardamount" id="rewardamount" class="span4" data-rule-required="true" value="<?php echo ($list["rewardamount"]); ?>" readonly>
		</div> -->
			<?php echo ($list["rewardamount"]); ?>
	</div>
	<div class="control-group">
		<label for="libao" class="control-label">领取状态：</label>
		<div>
			<!-- <input type="text" name="userName" id="userName" class="span4" data-rule-required="true" value="<?php echo ($serviceUser["userName"]); ?>"> -->
			<!-- <label for="yes"><input type="radio" name="libao" value="1" <?php if($list['libao'] == 1): ?>checked<?php endif; ?>>已领取</label>&nbsp;　&nbsp;&nbsp;
			<label for="no"><input type="radio" name="libao" value="0" <?php if($list['libao'] == 0): ?>checked<?php endif; ?>>未领取</label> -->
			<select name="rewardstatus">
              	<?php if($list['rewardstatus'] == 0): ?><option value="0" <?php if($list['rewardstatus'] == '0'): ?>selected<?php endif; ?>>获取佣金</option>
              	<?php elseif($list['rewardstatus'] == '-1'): ?>
              		<option value="-1" <?php if($list['rewardstatus'] == '0'): ?>selected<?php endif; ?>>购买商品</option>
              		<option value="-99" <?php if($list['rewardstatus'] == '-99'): ?>selected<?php endif; ?>>佣金撤销</option>
              	<?php elseif($list['rewardstatus'] == '-99'): ?>
              		<option value="-99" <?php if($list['rewardstatus'] == '-99'): ?>selected<?php endif; ?>>佣金撤销</option>
              	<?php else: ?>
	              	<option value="2" <?php if($list['rewardstatus'] == '2'): ?>selected<?php endif; ?>>取现申请</option>
	              	<option value="1" <?php if($list['rewardstatus'] == '1'): ?>selected<?php endif; ?>>佣金取现</option>
	              	<option value="-99" <?php if($list['rewardstatus'] == '-99'): ?>selected<?php endif; ?>>佣金撤销</option><?php endif; ?>
              		
			</select>
		</div>
	</div>
	<!-- <div class="control-group">
		<label for="Mtime" class="control-label">创建日期：</label>
		<div class="controls">
			<input type="text" name="Mtime" id="Mtime" class="span4" data-rule-required="true" value="<?php echo (date('Y-m-d',$list["Mtime"])); ?>" readonly>
		</div>
	</div> -->
   <div class="form-actions">
			<button id="bsubmit" type="submit" data-loading-text="提交中..." class="btnGreen">保存</button>　<a href="<?php echo U('Share/reward',array('token'=>$_GET['token']));?>" class="btnGray vm">取消</a>
		</div>
</form>
  </div> 
</div>