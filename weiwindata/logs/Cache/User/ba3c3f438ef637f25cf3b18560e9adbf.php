...
<div class="content">
<div class="cLineB">
<h4 class="left">会员卡设置</h4>
<div class="searchbar right">
</div>
<div class="clr"></div>
</div>
<div class="cLine">
<div class="pageNavigator left"> <a href='__ROOT__/index.php?g=User&m=Member_card&a=design&token=<?php echo ($token); ?>' title='新增会员卡' class='btnGrayS vm bigbtn'>添加会员卡</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
 <div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-top:5px;">在这里可以对管理员的功能进行操作</div>
...
<a href="__ROOT__/index.php?g=User&m=Member_card&a=design&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">设计</a> <a href="__ROOT__/index.php?g=User&m=Member_card&a=create&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">在线开卡</a> <a href="__ROOT__/index.php?g=User&m=Member_card&a=exchange&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">积分设置</a> <a href="__ROOT__/index.php?g=User&m=Member_card&a=notice&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">通知管理</a> <a href="__ROOT__/index.php?g=User&m=Member_card&a=privilege&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">特权管理</a> <a href="__ROOT__/index.php?g=User&m=Member_card&a=coupon&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">优惠券管理</a> <a href="__ROOT__/index.php?g=User&m=Member_card&a=integral&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">礼品券管理</a> <a href="__ROOT__/index.php?g=User&m=Member_card&a=members&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">会员管理</a> <a href="__ROOT__/index.php?g=User&m=Member_card&a=staff&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>">店员管理</a> <a href="javascript:drop_confirm('您确定要删除吗?', '__ROOT__/index.php?g=User&m=Member_card&a=delete&token=<?php echo ($token); ?>&id=<?php echo ($item["id"]); ?>');">删除</a></TD>
