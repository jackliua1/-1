...
<div class="content">
    <div class="cLineB"><h4>片区经理管理</h4></div>
    ...
    <div class="cLine">
        ...
        <div class="pageNavigator left">
            <a href="<?php echo U('Districtmanager/addAgent',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
                <img src="tpl/User/default/common/images/text.png" class="vm">添加片区经理
            </a>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
                ...
                <?php if($list == ''): ?><tr>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                            <td><span class="label"> <?php echo ($list['areaName']); ?></span></td>
                            <td><span class="label"> <?php echo ($list['areaTel']); ?></span></td>
                            <!--<td><span class="label"> <?php echo ($list['usersname']); ?></span></td>-->
                            <td><span class="label"> <?php echo (date('Y-m-d',$list["areaTime"])); ?></span></td>
                            <td>
                                <a href="<?php echo U('Districtmanager/update',array('ID'=>$list['ID'],'token'=>$list['Token']));?>" class="btn">修改</a>
                                &nbsp;<a href="<?php echo U('Districtmanager/del',array('ID'=>$list['ID'],'token'=>$list['Token']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn">删除</a></a>
                            </td>
