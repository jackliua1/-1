...
<div class="cLineB">
  ...
  <h4>在线支付配置 </h4>
   ...
   <div class="ftip" style="margin:10px 0">支持微信支付、财付通（WAP接口）和支付宝支付（即时到帐接口）。请填写真实信息，否则支付中可能会出现错误</div> 
		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<tr>
				...
				<tr>
					...
					<td><select name="paytype" onchange="ccolumns(this.value)"><option value="weixin" <?php if($config["paytype"] == 'weixin'): ?>selected<?php endif; ?>>微信支付</option><option value="alipay" <?php if($config["paytype"] == 'alipay'): ?>selected<?php endif; ?>>支付宝</option><option value="1" <?php if($config["paytype"] == 'tenpay'): ?>selected<?php endif; ?>>财付通</option></select> </td>
