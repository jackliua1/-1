...
<div class="msgWrap">
  <form class="form" method="post"   action="<?php echo U('Classify/upsave');?>"  target="_top" enctype="multipart/form-data" >
<TABLE class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
  <THEAD>

    <TR>
  <TH valign="top"><label for="keyword">关联楼盘：</label></TH>
  <TD>
...
<TR>
  ...
  <TD><input type="input" class="px" id="keyword" value="<?php echo ($info["name"]); ?>" name="name" style="width:500px" ><br />
                  </TD>
  <TD>&nbsp;</TD>
</TR>
                            </THEAD>
...
<TR>
  ...
  <TD><input type="input" class="px" id="keyword" value="<?php echo ($info["info"]); ?>" name="info" style="width:500px" ><br />
                  30个字简短分类描述，可为空   </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
  <TH valign="top"><label for="keyword">分类图片：</label></TH>
  <TD><input type="input" class="px" id="img" value="<?php echo ($info["img"]); ?>" name="img" style="width:500px" >  <script src="/tpl/static/upyun.js?2013"></script><a href="###" onclick="chooseFile('img','icon')" class="a_upload">选择</a> <a href="###" onclick="upyunPicUpload('img',700,420,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('img')">预览</a></TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
  <TH valign="top"><label for="url">外链网站或活动 ：</label></TH>
  <TD><input type="input" class="px" id="url" value="<?php echo ($info["url"]); ?>" name="url" style="width:300px" > <a href="###" onclick="addLink('url',0)" class="a_choose">从功能库添加</a><br />
                   </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
  <TH valign="top"><label for="keyword">排序：</label></TH>
  <TD><input type="input" class="px" id="keyword" value="<?php echo ($info["sorts"]); ?>" name="sorts" style="width:500px" ><br />
                   </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
