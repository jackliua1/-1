...
<div class="cLineB">
  <h4>新增项目总监</h4><a href="javascript:history.back(-1);" class="right btnGrayS vm">返回</a>
 </div> 
  <div class="msgWrap bgfc">
  <form action="" method="post" class="form-horizontal form-validate" novalidate="novalidate">
	<div class="control-group">
		<label for="title" class="control-label">项目总监姓名：</label>
		<div class="controls">
			<input type="text" name="Name" id="title" maxlength="10" class="span4" value="<?php echo ($serviceUser["Name"]); ?>" data-rule-required="true"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		<label for="Tel" class="control-label">项目总监电话：</label>
		<div class="controls">
			<input type="text" name="Tel" id="Tel" class="span4" data-rule-required="true" value="<?php echo ($serviceUser["Tel"]); ?>"><span class="maroon">*</span><span class="help-inline">请填写正确的手机号码</span>
		</div>
	</div>
	<div class="control-group">
		<label for="password" class="control-label">登录密码：</label>
		<div class="controls">
			<input type="password" name="password" id="password" class="span4" data-rule-required="true" value=""><span class="maroon">*</span><span class="help-inline">手机端登录使用</span>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<select name="Uid[]" class="chosen-select" data-placeholder="选择所属项目" id="Uid" multiple>
				<option value=""></option>
		        <?php if(is_array($lp)): $i = 0; $__LIST__ = $lp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lp): $mod = ($i % 2 );++$i;?><option value="<?php echo ($lp["ID"]); ?>"><?php echo ($lp["LouPanTitle"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		      </select>
		</div>
	</div>
	<!-- <div class="control-group">
		...
		<div class="controls">
			<input type="text" name="addTime" id="addTime" class="span4" data-rule-required="true" value="<?php echo ($serviceUser["addTime"]); ?>"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div>
	<div class="control-group">
		<label for="BDTime" class="control-label">绑定日期：</label>
		<div class="controls">
			<input type="text" name="BDTime" id="BDTime" class="span4" data-rule-required="true" value="<?php echo ($serviceUser["BDTime"]); ?>"><span class="maroon">*</span><span class="help-inline"></span>
		</div>
	</div> -->
