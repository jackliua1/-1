...
<div class="cLine">
<div class="pageNavigator left"> <a href="###" onclick="$('#info').submit()" title="" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">处理订单</a>

  <a href="/index.php?g=User&m=Store&a=out_execle&token=<?php echo ($_GET['token']); ?>&id=<?php echo ($thisCard["id"]); ?>" title="导出订单" class="btnGrayS vm bigbtn">导出订单</a>
</div>
<div class="clr"></div>
</div>
...
<td>
	...
	<?php elseif($o['paymode'] == 4): ?><span style="color:green">积分支付</span>
	<?php elseif($o['paymode'] == 5): ?><span style="color:green">佣金支付</span>
