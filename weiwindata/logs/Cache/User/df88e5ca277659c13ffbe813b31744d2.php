...
<a href="<?php echo U('Store/setting', array('token' => $token));?>" title="商城设置" class="btnGrayS vm bigbtn" style="color:#000;"><img src="<?php echo RES;?>/images/product/add.png" class="vm">商城设置</a>
</div>
<div class="clr"></div>
</div>
<div class="msgWrap">
