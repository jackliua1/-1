...
<div class="content">
        ...
        <div class="msgWrap form">
          <ul id="tags" style="width:100%">
            ...
            <li>
              <a href="?g=User&m=Expert&a=index1&token=<?php echo ($list[0]['token']); ?>">达人参与活动</a> 
            </li>
              ...
              <thead>
                <tr>
                  <th width="40%">达人姓名</th>
        					...
        					<th class="norightborder" width="20%">操作</th>
                </tr>
              </thead>
              <tbody>
              <?php if($list == null): ?><tr>
                  <td colspan="3" style="text-align:center; height:30px;"><strong>暂无达人信息</strong></td>
                </tr><?php endif; ?>
    			   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                  <td width="100px"><?php echo ($list["expertname"]); ?></td>
                  ...
                  <td class="norightborder">
    						<a href="<?php echo U('Expert/edit',array('id'=>$list['id'],'token'=>$list['token']));?>">修改</a>&nbsp;&nbsp;
                <a href="<?php echo U('Expert/del',array('id'=>$list['id'],'token'=>$list['token']));?>"  onclick="return(confirm('确定要删除吗？'))">删除</a>
    				   </td>
