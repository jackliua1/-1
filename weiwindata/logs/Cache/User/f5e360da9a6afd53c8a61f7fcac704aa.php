...
<div class="content" <?php if(session('isQcloud') == true): ?>style="float:center;"<?php endif; ?>>
          <div class="cLineB"><h4>编辑达人信息</h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a></div>
         
          <form method="post"   action="<?php echo U('Custom/upsave',array('token'=>$_GET['token']));?>"  enctype="multipart/form-data" >
            ...
            <TABLE class="userinfoArea" border="0" cellSpacing="0" cellPadding="0" width="100%">
              <THEAD>
                <TR>
                  ...
                  <TD>
                    <input type="text" class="px" id="sharename" value="<?php echo ($info["sharename"]); ?>"  style="width:280px;" readonly>
                    <!-- <input type="hidden" class="px" name="sid" value="<?php echo ($info["sid"]); ?>"> -->
                  </TD>
                </TR>
              </THEAD>
              <TBODY>
                 <TR>
                  <TH style="width:120px" valign="top"><label for="customname">客户姓名：</label></TH>
                  <TD><input type="text" class="px" id="customname" value="<?php echo ($info["customname"]); ?>"  name="customname" style="width:280px;"></TD>
                </TR>
                 <TR>
                  <TH style="width:120px" valign="top"><label for="customphone">客户电话：</label></TH>
                  <TD><input type="text" class="px" id="customphone" value="<?php echo ($info["customphone"]); ?>"  name="customphone" style="width:280px;"></TD>
                </TR>
                 <TR>
                  <TH style="width:120px" valign="top"><label for="LouPanTitle">预约项目：</label></TH>
                  <TD><input type="text" class="px" id="LouPanTitle" value="<?php echo ($info["LouPanTitle"]); ?>"  name="LouPanTitle" style="width:280px;" readonly></TD>
                </TR> 
                <TR>
                  <TH></TH>
                  <TD><input type="submit" value="保存" name="sbmt" class="btnGreen left">　<a href="<?php echo U('Custom/index',array('token'=>$_GET['token']));?>"  class="btnGray vm">取消</a></TD>
                </TR>
              </TBODY>
            </TABLE>
