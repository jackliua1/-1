...
<body  >
    ...
    <form action="#" method="post">
        <div class="reg_content">
            ...
            <input type="text"  value="<?php echo ($zyinfo['Name']); ?>" disabled class="reg_cone" name="Name" id="name">
            <input type="text"  value="<?php echo ($zyinfo['Tel']); ?>" disabled onkeyup="this.value=this.value.replace(/[^\d]/g,'')" name="Tel" id="tel">
...
<script language="javascript">
	...
	$("#logout").on('click',function(){
		location.href="<?php echo U('Zhiye/register',array('token'=>$token));?>";
	});
</script>
</html>