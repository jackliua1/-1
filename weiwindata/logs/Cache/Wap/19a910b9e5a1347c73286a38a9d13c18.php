...
<body>
	<p  class="mid_reg">我的客户</p>
     ...
     <div class="mykh_top">
     	<div class="top_newkh">
            <a href="<?php echo U('Zhiye/newcustom',array('token'=>$zy['Token'],'wecha_id'=>$zy['Wecha_id'],'Uid'=>$zy['Uid']));?>">新客户</a>
        </div> 
     	<div class="top_nowkh_">跟进中</div> 
     	<div class="top_ovekh">
            <a href="<?php echo U('Zhiye/endcustom',array('token'=>$zy['Token'],'wecha_id'=>$zy['Wecha_id']));?>">已结束</a>
        </div>
         ...
         <!--跟进客户-->
            ...
            <?php else: ?> 
                <?php if(is_array($kh)): $i = 0; $__LIST__ = $kh;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="mykh_cli" style="background-color:#fff;">  	
                     <a href="<?php echo U('Zhiye/custominfo',array('token'=>$zy['Token'],'wecha_id'=>$zy['Wecha_id'],'id'=>$vo['ID']));?>"> 
                    ...
                    <span  class="my_client_name"  style=" width:20%;  ">
                     <span class="mykhhk_span" style="background:#4595F4;"><?php echo ($vo["salesstatus"]); ?></span>
                    </span>
