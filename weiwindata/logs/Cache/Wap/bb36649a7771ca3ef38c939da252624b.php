...
<style>
	...
	.status{margin-top:10px;width:90%;height:39px;line-height:39px;background-color:#fff;border: #d1d1d1 1px solid;
		...
		font-size: 14px;
		color: #999;}
	.isfk,.istf{width:91%;height:28px;line-height:28px;background-color:#fff;border: #d1d1d1 1px solid;
		outline: none;
		border-radius: 5px;
		text-indent: 1em;
		font-size: 14px;
...
<body>
  ...
  <?php if($kh[JJ_id] == 0): ?><span style="text-indent:10px;">推荐人</span>
	...
	<form action="<?php echo U('Zhiye/custommodify',array('token'=>$token));?>" method="post">
		<div class="reg_content">
			...
			<?php elseif(($status == 2) or ($status == 3)): ?>
				...
				<div class="info"><div class="name">收据编号3：</div><div class="value"><input type="text" name="sjnum3" placeholder="收据编号3" class="sjnum3" value="<?php echo ($kh["sjnum3"]); ?>"></div></div>
				<br/>
				<div class="info"><div class="name">应付金额：</div><div class="value"><input type="text" name="yfje" placeholder="应付金额" class="yfje" value="<?php echo ($kh["yfje"]); ?>"></div></div>
				<div class="info"><div class="name">中介奖励：</div><div class="value"><input type="text" name="jjrjl" placeholder="中介奖励" class="jjrjl" value="<?php echo ($kh["jjrjl"]); ?>"></div></div>
				<div class="info"><div class="name">是否已付：</div><div class="value">
				<select name="isfk" class="isfk">
					<option value="">--是否已付--</option>
					<option value="1" <?php if($kh[isfk] == 1): ?>selected<?php endif; ?>>否</option>
					<option value="2" <?php if($kh[isfk] == 2): ?>selected<?php endif; ?>>是</option>
				</select>
				</div></div>
				<div class="info"><div class="name">是否退房：</div><div class="value">
				<select name="istf" class="istf">
					<option value="">--是否退房--</option>
					<option value="1" <?php if($kh[istf] == 1): ?>selected<?php endif; ?>>否</option>
					<option value="2" <?php if($kh[istf] == 2): ?>selected<?php endif; ?>>是</option>
				</select>
				</div></div>
				<div class="info"><div class="name">备注：</div><div class="value"><input type="text" name="remark" placeholder="备注" class="remark" value="<?php echo ($kh["remark"]); ?>"></div></div><?php endif; ?>
