...
<style type="text/css">
	.m-list>li>span{display:inline;}
</style>
<div class="m-select c666 order_control">
<span style="  margin:0px; width:50px; over-fllower:hidden; padding:0px;  "><a href="javascript:" order="time" class="arrow-down">时间<i><em></em></i></a></span>
<span style="  margin:0px; width:50px; over-fllower:hidden; padding:0px;  "><a href="javascript:" order="salecount">销量<i><em></em></i></a></span>
<span style="  margin:0px; width:50px; over-fllower:hidden; padding:0px;  "><a href="javascript:" order="price">价格<i><em></em></i></a></span>
<span style="  margin:0px; width:50px; over-fllower:hidden; padding:0px;  "><a href="javascript:" order="discount">折扣<i><em></em></i></a></span>
...
<ul id="m_list" class="m-list " style=" min-height:300px;">
<?php if(is_array($products)): $i = 0; $__LIST__ = $products;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hostlist): $mod = ($i % 2 );++$i;?><li>
		...
		<span class="con">
			<a class="t" href="<?php echo U('Store/product',array('token' => $_GET['token'], 'id' => $hostlist['id'], 'wecha_id' => $_GET['wecha_id']));?>"  style="white-space:normal; width:90%;"><?php echo ($hostlist["name"]); ?></a>
			<div><b>￥<?php echo ($hostlist["price"]); ?></b><del>￥<?php echo ($hostlist["oprice"]); ?></del></div>
		</span>
